...
class InfibeamScraper(BaseScraper):
	...
	def __init__(self,filepath):
		BaseScraper.__init__(self,filepath)
	...
	def process(self, url, page, dump):
		...
		#writing to dump
		dump.write(data["name"]+delimit+data["price"]+delimit+data["vendor"]+delimit+data["image"]+delimit+data["description"]+delimit+data["specs"]+"*@*")
		return True
